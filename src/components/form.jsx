  ...
  return (
    ...
    <form action="" onSubmit={handleSubmit}>
        ...
        <div className="d-flex mt-3">
          ...
          <div className="flex-grow-1 ms-2">
             <input type="text" name='subject' value={formData.subject} placeholder='Purpose' className={`form-control ${errors.subject && 'is-invalid'}`} onChange={handleChange} /> 
             {errors.subject && <div className='invalid-feedback'>{errors.subject}</div>}  
          </div>
        </div>
        <textarea name="Order online" id="" value={formData.message} cols="30" rows="10" className={`form-control mt-3 ${errors.name && 'is-invalid'}`} onChange={handleChange} placeholder='Enter your Message here'></textarea>
